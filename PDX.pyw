...
root.title("PDX \xa9 ศูนย์ราชการสะดวก สป.ทส.")
...
root.option_add('*Dialog.msg.font', 18)

# Set the program name
programName = "Personal Data Expert"

# Set the font name and font size variables in the program window
programNameFont = "Courier"
programNameFontSize = 20

# Set the disclaimer text
disclaimerText = "ซอฟต์แวร์นี้ พัฒนาโดย " \
             "กองกลาง (ส่วนข้อมูลข่าวสารและบริการร่วม) ภายใต้โครงการพัฒนาปัญญาประดิษฐ์ ช่วยพิจารณาการ" \
             "เปิดเผยข้อมูลส่วนบุคคลของสำนักงานปลัดกระทรวง" \
             "ทรัพยากรธรรมชาติและสิ่งแวดล้อม และเผยแพร่" \
             "ซอฟต์แวร์นี้ เพื่อรับคำแนะนำในการปรับปรุง" \
             "การทำงานของซอฟแวร์ ผู้พัฒนา จึงไม่รับรองความถูกต้อง" \
             "หรือประสิทธิภาพการทำงานของซอฟต์แวร์ " \
             "ตลอดจนไม่รับประกันความเสียหายต่าง ๆ อันเกิดจากการ" \
             "ใช้ซอฟต์แวร์นี้ ท่านได้อ่านและยอมรับข้อตกลง" \
             "การใช้ซอฟแวร์นี้หรือไม่?"
...
def Query():
    ...
    if question0.get() == Option1: # Owner
        ...
        label = Label(root, text=programName, font=(programNameFont, programNameFontSize))
        label.pack()
        ...
        startButton = Button(root, text="START", command=AIEngine).pack()
...
# Create button, it will change label text
startButton = Button(root, text="START", command=Disclaimer).pack(padx=100)
...
# Create button, it will change label text
startButton = Button(root, text="คู่มือ", command=openReadMe).pack(padx=100)
