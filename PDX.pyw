...
# Set output button label
outputButtonLabel = "บันทึกความเห็นของ AI"
...
root.title("Personal Data Expert")
...
programLabel = Label(frame,
                     text="PDX [Version 2.0.1]",
                     bg="blue",
                     fg="white",
                     font="Consolas 10"
                     ).place(x=1, y=1)
copyrightLabel = Label(frame,
                       text="\xa9 MNRE General Affairs Division. All rights reserved.",
                       bg="blue",
                       fg="white",
                       font="Consolas 10"
                       ).place(x=1, y=20)
...
disclaimerText = "ซอฟต์แวร์นี้ พัฒนาโดยนายมนตรี เกียรติเผ่าพันธ์ ภายใต้โครงการพัฒนาปัญญาประดิษฐ์ " \
                 "ช่วยพิจารณาการเปิดเผยข้อมูลส่วนบุคคลของสำนักงานปลัดกระทรวง" \
                 "ทรัพยากรธรรมชาติและสิ่งแวดล้อม และเผยแพร่ซอฟต์แวร์นี้ " \
                 "เพื่อทดสอบการทำงานของซอฟแวร์ ผู้พัฒนา" \
                 "จึงไม่รับรองความถูกต้องของ" \
...
Option2_1 = "2.1 ได้รับความยินยอมจากเจ้าของข้อมูลที่ให้ความยินยอมตามลำพังได้ หรือผู้ใช้อำนาจปกครอง หรือผู้อนุบาล หรือผู้พิทักษ์"
...
# Set functions to open the output text files
def openOutput1_1_1File():
    os.system("output1_1_1.txt")
def openOutput1_1_2File():
    os.system("output1_1_2.txt")
def openOutput1_2_1File():
    os.system("output1_2_1.txt")
def openOutput1_2_2File():
    os.system("output1_2_2.txt")
def openOutput1_3File():
    os.system("output1_3.txt")
def openOutput2_1_1File():
    os.system("output2_1_1.txt")
def openOutput2_1_2File():
    os.system("output2_1_2.txt")
def openOutput2_2_1File():
    os.system("output2_2_1.txt")
def openOutput2_2_2File():
    os.system("output2_2_2.txt")
...
def Query2_2():
    ...
    # If Option 2.2.2 (No laws allows) is clicked,
        ...
        # define a function to save output
        output2_2_2File = open("output2_2_2.txt", "a", encoding="utf-8")
        # Indend in the next line
        output2_2_2File.write(" ")
        # Write the customer name and surname in Thai
        output2_2_2File.write(output2_2_2.get() + "\n")
        # Close the output file
        output2_2_2File.close()
        # Create button to open the file that records the AI opinion
        Output2_2_2Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput2_2_2File)
...
def Query2_1_1():
       ...
       if question2_1.get() == Option2_1_1:
           # define a function to save output
           output2_1_1File = open("output2_1_1.txt", "a", encoding="utf-8")
           # Indend in the next line
           output2_1_1File.write(" ")
           # Write the customer name and surname in Thai
           output2_1_1File.write(output2_1_1.get() + "\n")
           # Close the output file
           output2_1_1File.close()
           # Create button to open the file that records the AI opinion
           Output2_1_1Label = Button(root,
                                     text=outputButtonLabel,
                                     command=openOutput2_1_1File)
       ...
       # If Choice 2.1.2 is selected, then give the opinion
           ...
           # define a function to save output
           output2_1_2File = open("output2_1_2.txt", "a", encoding="utf-8")
           # Indend in the next line
           output2_1_2File.write(" ")
           # Write the customer name and surname in Thai
           output2_1_2File.write(output2_1_2.get() + "\n")
           # Close the output file
           output2_1_2File.close()
           # Create button to open the file that records the AI opinion
           Output2_1_2Label = Button(root,
                                     text=outputButtonLabel,
                                     command=openOutput2_1_2File)
...
def Query1():
    ...
    # If Option 1.3 is clicked (Transferred data), go to Output 1.3
        ...
        # define a function to save output
        output1_3File = open("output1_3.txt", "a", encoding="utf-8")
        # Indend in the next line
        output1_3File.write(" ")
        # Write the customer name and surname in Thai
        output1_3File.write(output1_3.get() + "\n")
        # Close the output file
        output1_3File.close()
        # Create button to open the file that records the AI opinion
        Output1_3Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput1_3File)
        Output1_3Label.pack()
...
def Query1_1():
    ...
    if question1_1.get() == Option1_1_1:
        # define a function to save output
        output1_1_1File = open("output1_1_1.txt", "a", encoding="utf-8")
        # Indend in the next line
        output1_1_1File.write(" ")
        # Write the customer name and surname in Thai
        output1_1_1File.write(output1_1_1.get() + "\n")
        # Close the output file
        output1_1_1File.close()
        # Create button to open the file that records the AI opinion
        Output1_1_1Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput1_1_1File)
    ...
    # If the answer is Option 1.1.2 (No, there is no laws)
        ...
        # define a function to save output
        output1_1_2File = open("output1_1_2.txt", "a", encoding="utf-8")
        # Indend in the next line
        output1_1_2File.write(" ")
        # Write the customer name and surname in Thai
        output1_1_2File.write(output1_1_2.get() + "\n")
        # Close the output file
        output1_1_2File.close()
        # Create button to open the file that records the AI opinion
        Output1_1_2Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput1_1_2File)
...
def Query1_2():
    ...
    if question1_2.get() == Option1_2_1:
        # define a function to save output
        output1_2_1File = open("output1_2_1.txt", "a", encoding="utf-8")
        # Indend in the next line
        output1_2_1File.write(" ")
        # Write the customer name and surname in Thai
        output1_2_1File.write(output1_2_1.get() + "\n")
        # Close the output file
        output1_2_1File.close()
        # Create button to open the file that records the AI opinion
        Output1_2_1Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput1_2_1File)
    ...
    # Show text on the program screen: Done!
        ...
        # define a function to save output
        output1_2_2File = open("output1_2_2.txt", "a", encoding="utf-8")
        # Indend in the next line
        output1_2_2File.write(" ")
        # Write the customer name and surname in Thai
        output1_2_2File.write(output1_2_2.get() + "\n")
        # Close the output file
        output1_2_2File.close()
        # Create button to open the file that records the AI opinion
        Output1_2_2Label = Button(root,
                                  text=outputButtonLabel,
                                  command=openOutput1_2_2File)
